...
/****************************************************************************/
		...
		int DW1000_fpsp_n();
		int DW1000_rx_c();
		double DW1000_readFirstPathSignalPower(int PRF);		// estimate first path signal power
		double DW1000_readRxLevel(int PRF);				// estimate receive signal power
		...
		int DW1000__rst;								// Reset pin (pin 9)
		long DW1000__syscfg;							// System Config
		long DW1000__sysstat;							// System Status
		long DW1000__ICtemp;							// IC temperature readings
		long DW1000__ICvoltage;						// IC voltage readings
		
		/* Read/write helper functions */
		static const uint8_t DW1000_READ = 0x00;
		static const uint8_t DW1000_READ_SUB = 0x40;
		static const uint8_t DW1000_WRITE = 0x80;
		static const uint8_t DW1000_WRITE_SUB = 0xC0;

		static const uint8_t DW1000_SUB = 0x01;			// Sub-indexing is used
		static const uint8_t DW1000_NO_SUB = 0x00;		// No sub-indexing
		static const uint8_t DW1000_NO_OFFSET = 0x00;		// No offset
